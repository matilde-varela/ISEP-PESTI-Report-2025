...
Da mesma forma, a um nível de granularidade grande, ambas os casos de uso UC-06 e UC-07 são bastante semelhantes, mudando apenas a lógica do negócio, como ilustrado na Figura \ref{fig:UC67-lvl1}.
